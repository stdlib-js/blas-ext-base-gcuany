...
```javascript
import gcuany from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcuany@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcuany@deno/mod.js';
```
