...
*
* gcuany( 4, arraylike2object( toAccessorArray( x ) ), 1, 0, arraylike2object( toAccessorArray( out ) ), 1, 0 );
* // out => [ false, false, true, true ]
*/
function gcuany( N, x, strideX, offsetX, out, strideOut, offsetOut ) {
	var xbuf;
	var obuf;
	var get;
	var set;
